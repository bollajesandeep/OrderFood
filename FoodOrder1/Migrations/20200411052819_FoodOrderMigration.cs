...
namespace FoodOrder1.Migrations
{
    public partial class FoodOrderMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Restaurents_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Restaurents_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "FoodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Restaurents_CategoryId",
                table: "Restaurents",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Restaurents_FoodId",
                table: "Restaurents",
                column: "FoodId");
